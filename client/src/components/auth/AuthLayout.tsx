    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', bgcolor: 'background.default' }}>
      ...
      >
        <Stack spacing={4} sx={{ position: 'relative', zIndex: 1, maxWidth: 460 }}>
          <Logo size={48} variant="inverse" subtitle="Plateforme d'analyse ECG" />

          <Typography
            variant="h1"
            sx={{ color: 'common.white', fontSize: { md: '2rem', lg: '2.375rem' }, lineHeight: 1.2 }}
          >
      ...
      >
        <Box sx={{ width: '100%', maxWidth: 440 }}>
          ...
          <Stack
            direction="row"
            spacing={0.75}
            sx={{ alignItems: 'center', justifyContent: 'center', mt: 3, color: 'text.secondary' }}
          >
